...
export const BACKUPS_SCHEDULER_DISCONNECT_EVENT_TYPE =
  "scheduler_disconnect_request";
...
export const BACKUPS_MPI_SCHEDULER_DISCONNECT_REQUEST_MESSAGE =
  "DATOCMS_AUTOMATIC_BACKUPS_PLUGIN_SCHEDULER_DISCONNECT";
export const BACKUPS_MPI_SCHEDULER_DISCONNECT_RESPONSE_MESSAGE =
  "DATOCMS_AUTOMATIC_BACKUPS_LAMBDA_SCHEDULER_DISCONNECTED";
